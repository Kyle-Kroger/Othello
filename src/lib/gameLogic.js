...
// const gameLogic = {
//   validMoves: (gameboard, color) => {
//     const newGameboard = [...gameboard].map((row, rowI) => {
//       return row.map((col, colI) => {
//         if (col.state === "e") {
//           const surroundingOppositePieces = this.checkAdjacentSquares(
//             gameboard,
//             color,
//             rowI,
//             colI
...
//     return newGameboard;
//   },
//   validateMove: (gameboard, color, x, y, oppAdjacentArr) => {
//     const opposite = color === "w" ? "b" : "w";
//     for (let oppAdjacent of oppAdjacentArr) {
//       let { x: currX, y: currY } = oppAdjacent;
//       const xDir = oppAdjacent.x - x;
...
//     }
//   },
//   checkAdjacentSquares: (gameboard, color, x, y) => {
//     const opposite = color === "w" ? "b" : "w";
//     const surrounding = [
//       { x: x - 1, y: y - 1 },
//       { x: x - 1, y },
